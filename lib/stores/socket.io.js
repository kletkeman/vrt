...
Store.prototype.__proto__ = module.IPC.prototype;
...
module.IPC.convert.apply(Cluster.prototype, ['hget','hset','hdel', {name: 'del', sync: true}, 'hexists', {name : 'expire', sync: true}]);
