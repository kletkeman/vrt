...
ClientStore.prototype.receive = function(id, eventHandlerName, args) {
	...
	(this._queue || (this._queue = new vrt.Api.Queue({timeout : 30000}))).stash(id, arguments)(function(guid, set) {
		...
		if(!guid)
			set(eventHandlerName === 'onCreate' ? id : (vrt.Api.DataSet.collection[id]||{}).id);
		...
		var id = args_[0],
			...
			args = args_[2],
            obj = (vrt.Api.DataSet.collection[id]||vrt.Api.DataSet.prototype);
			
		obj[eventHandlerName].apply(obj, args);
	});
