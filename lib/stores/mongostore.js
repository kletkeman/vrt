...
MongoStore.prototype._unlock = function(name, args1) {
    ...
    assert.notEqual(typeof args1, 'undefined');
    ...
    if(lock.length) {
        ...
        while((args2 = lock.shift()))
        {
            ...
            assert.equal(args2.tag, undefined);
            args2.tag = (new Error()).stack;
...
MongoStore.prototype._count = function (collection, callback) {
    ...
    var lockname = collection.collectionName, args_ = arguments, context = this;
