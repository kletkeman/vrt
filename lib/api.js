...
function(
    ...
    , debug
      ...
      function Api(options) {
          ...
          var context = this, trg = trigger.call(this);
          ...
          Object.defineProperties(this, {
              ...
              trigger : {
                configurable : false,
                get : function () {
                    return (!this.browser && setImmediate(function () {
                        return context.dump.call(context);
                    })), trg;
                }
              },
              __readyQueue: {
          ...
          this.toJSON = this.toBSON = function () {
              return {trigger: trg.toJSON()};
          };
      ...
      Api.prototype.ready = function (callback) {
          ...
          debug("Api : ", 
                state ? "waiting, counting down" : "ready now, will fire callbacks now", 
      ...
      Api.prototype.register = function register (obj, ns) {
        ...
        if(this.browser) {
          ...
          }).once("connect", function () { return context.ready(-1); }).connect();
        }
        else if(this.io)
      ...
      Api.prototype.create = function (fields, callback) {
          ...
          return this.type(fields.type), this.ready(function () {
              return create(undefined, fields, function (err, obj) {
                  ...
                  return context.store.create(fields, callback);
              });            
          });
           ...
           return this.get(id, function(err, obj) {
             ...
             return obj.delete.apply(obj, (filter_index !== undefined ? [filter_index] : []).concat(path ? [path] : []).concat([
                 function(err, info) {
                     ...
                     return (typeof callback === 'function' ? callback.call(context, undefined, info) : undefined), ( context.browser || (obj.onDelete(info), context.store.save(obj, context.log.error) ) );
      ...
      Api.prototype.publish  = function (id, eventHandlerName, args, callback) {
          ...
          return (typeof callback === 'function' && callback.call(this)), (nsp && nsp.emit('event', _args));   
      };
