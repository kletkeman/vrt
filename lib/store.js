;!(function(module, require, undefined) {
	...
	Store.prototype.tree = {};

	Store.prototype.tree.get = function() {
		...
		for(var i = 0, len = path.length, tree = this, name; i < len; i++) {
			...
			if(typeof tree[name] !== 'object')
				tree = new (function(key, value) {this[key] = value;})(name, tree[name]);
			else
				tree = tree[name];
	...
	Store.prototype.tree.delete = function(path, callback) {
	...
	Store.prototype.tree.write = function(path, data, callback) {
