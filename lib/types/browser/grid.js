define(['jquery', 'types/dataset', 'lib/types/base/grid', 'lib/api', 'd3', 'js/viewcontroller.contextmenu'], function($, DataSet, Grid, vrt, d3, contextmenu) {
        ...
        function draw () {
            ...
            while(buffer.length) {
                ...
                if (obj instanceof Row) {
                    ...
                    if( ! obj.draw(width_cache, x_cache) )
                        buffer.push(obj);                   
    ...
    Row.prototype.draw = function (width_cache, x_cache) {
        ...
        var marked     = this.marked,
            ...
            w          = canvas.width,
            ctx        = canvas.getContext("2d"),
            x, width, cell, column, label, value, textHeight = Math.max(Math.floor(height / 2), 0),
