$.extend(vrt.Api.Bubbletrouble.prototype, vrt.Api.Bubbletrouble.prototype.__proto__);
...
vrt.Api.Bubbletrouble.prototype.create = function() {
	...
	setInterval(function() {
		...
		var data = test[ Math.round(Math.random() * test.length - 1) ];
