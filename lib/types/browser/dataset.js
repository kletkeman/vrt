...
function (
  ...
  DataSet.prototype.onCreate = function(config) {
    ...
    return this.onResize(), this.create(), ((this.group === (vrt.controls.dock.windows.activate()||{}).name) && this.render('show'));
  ...
  DataSet.prototype.destroy = function() {
    return this.contextmenu.destroy(), this.toolbar.destroy(), this.hide();
  }
