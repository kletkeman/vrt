...
vrt.Api.DataSet.prototype.onSave = function(data) {
    return $.extend(this, this.fromJSON.call(data)), (this.event = $.extend(new Event('save'), {data: data})), this.update();
};

vrt.Api.DataSet.prototype.onDelete = function(info, data) {
    return $.extend(this, this.fromJSON.call(data)), (this.event = $.extend(new Event('delete'), Store.delete.call(this, (info.filter || info.index), info.path, 'data')) ), this.update();
};
