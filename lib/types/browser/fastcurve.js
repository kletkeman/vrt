define(['types/dataset', 'lib/types/base/fastcurve', 'lib/api', 'd3'], function( DataSet, FastCurve, vrt, d3 ) {
    ...
    FastCurve.prototype.create = function () {
        ...
        this.toolbar.add("zoom", "Click hold and move cursor around to zoom, move",
          function click (d) {
              ...
              if(selection.classed("zooming")) {
                ...
                .on("contextmenu", function() { return d3.event.preventDefault(), click.call(selection.node(), d); })
        ...
        .on("contextmenu", function() {
            d3.event.preventDefault(), context.brush.clear(), (extent = null), context.overlay.select("g.brush.x").call(brush), context.draw(true);
        })
    ...
    FastCurve.prototype.draw = function ( force ) {
        ...
        overlay = overlay.selectAll("g.legend")
                             .data(this.curves.sort(function(c0, c1) { return c0.index > c1.index;}));
    ...
    FastCurve.prototype.show = function () {
        return this.start(), DataSet.prototype.show.apply(this, arguments);
    };
