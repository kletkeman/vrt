;!(function(module, Guid) {
  ...
  DataSet.prototype.delete = function() {
    // Parameter 0 type number deletes index, if object and buffersize > 0 uses object as filter to delete, 
    // if second parameter is string in dot format delete from object in array.
    // If param 0 is string and buffersize = 0, and argument(s) is string delete the key from data object.
  };
