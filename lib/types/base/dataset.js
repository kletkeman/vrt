;!(function(module, Guid) {
  ...
  DataSet.prototype.select = function(selector, callback) {
	 return vrt.store.select(this.id, selector, callback);
  };

  DataSet.prototype.update = function(selector, data, callback) {
   return vrt.store.update(this.id, selector, data, callback);
  };
