define(['jquery', 'guid', 'lib/api'], function($, Guid, vrt) {
  ...
  DataSet.destroy = function() {
      ...
      if(!vrt.browser && typeof this.schema === 'object')
        Route.remove(this.schema);
                                      
      if(stack = Stack.findParent(this))
          return stack.destroy(this);
  };
                                      
  DataSet.prototype.destroy = function() {
    return vrt.destroy(this.id);
  };
