define(['types/dataset', 'lib/template', 'lib/types/base/stack', 'lib/api'], function (DataSet, Template, Stack, vrt) {
            ...
            this.queue.stash(key, data)(function(id, set) {
                ...
                if(!id)
                {
                    ...
                    var dummy = {
                        title: context.title, 
                        datasets: {}
                    }, blueprint = $.extend({}, context.blueprint), Template = require('../../base').Template;
